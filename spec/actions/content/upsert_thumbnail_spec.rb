...
#   let(:thumbnail) { FactoryGirl.create(:image_thumbnail_file) }
#
...
#       expect(thumb.label).to eq 'image.jpg'
#       $stderr.puts core_file.thumbnail
#       $stderr.puts core_file.thumbnail_list
...
#       expect(core_file.thumbnail).not_to be nil
#
#       count = core_file.content_objects.count do |content_object|
#         content_object.class = 'ImageThumbnailFile'
#       end
#
