...
describe UpsertCommunity do
  ...
  RSpec.shared_examples 'a comm metadata assigning operation' do
  ...
  RSpec.shared_examples 'a comm thumbnail updating operation' do
  ...
  context 'Create' do
    context 'with a thumbnail specified' do
      ...
      it_should_behave_like 'a comm metadata assigning operation'
      it_should_behave_like 'a comm thumbnail updating operation'
    end
