...
describe CoreFile do
  ...
  describe "HTML Object Queries" do
    ...
    it "can retrieve this CoreFile's teibp object" do
      ...
      expect(teibp.class).to eq HTMLFile
      expect(teibp.pid).to eq @teibp.pid

      # expect(teibp(:raw)['id']).to eq @teibp.pid
      # expect(teibp(:solr_doc).pid).to eq @teibp.pid
    end
    ...
    it "can retrieve this CoreFile's tapas_generic object" do
      ...
      expect(tapas_generic.class).to eq HTMLFile
      expect(tapas_generic.pid).to eq @tapas_generic.pid
