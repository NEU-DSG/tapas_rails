...
describe 'TapasQueries' do
  ...
  describe '#all_ography_tei_files' do
    ...
    it "can retrieve all ography tei files associated with a CoreFile's"\
      ...
      result = core_file.all_ography_tei_files
      result.map! { |x| x.pid }
  ...
  #   let(:thumbnail_file) { FactoryGirl.create :image_thumbnail_file }
  #
  #   it 'returns nil for Communities' do
  #     expect(community.thumbnail_list).to be nil
  #   end
  #
  #   it 'returns nil for Collections' do
  #     expect(collection.thumbnail_list).to be nil
  #   end
  #
  #   it 'returns nil for CoreFiles with no thumbnail' do
  #     expect(core_file.thumbnail_list).to be nil
  #   end
  #
  ...
  #
  #     expect(model.thumbnail_list[0]).to eq thumbnail_file
  #     expect(doc.thumbnail_list[0]).to eq thumbnail_file
  #
